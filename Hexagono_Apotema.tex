...
\draw [color=cqcqcq,, xstep=1cm,ystep=1cm] (-4.3,-5.14) grid (15.26,6.3);
...
\draw [line width=2pt] (1,1.7320508075688779)-- (1,0);
\begin{scriptsize}
\draw [fill=uuuuuu] (1,0) circle (2pt);
\draw [fill=uuuuuu] (1,1.7320508075688779) circle (2pt);
